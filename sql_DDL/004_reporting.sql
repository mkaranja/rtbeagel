-- =====================================================================
-- RTB-EAGEL · 004 · Reporting, dispatch, and sample disposition
-- Run after 003_stages.sql.
-- ---------------------------------------------------------------------
...
-- 5) DISPATCH
--
-- Who sent what, to whom, when, and did it arrive. tbl_order.results_dispatch
-- already said "Electronically" but nothing recorded whether it happened.
-- ---------------------------------------------------------------------
...
SELECT
    ...
    o.results_dispatch AS preferred_method,
    rc.approved_on
